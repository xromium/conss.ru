...
class StickyHeader {
  ...
  events() {
    window.addEventListener(
      "scroll",
      throttle_default()(() => this.runOnScroll(), 200)
    )
  }
...
let stickyHeader = new modules_StickyHeader()

new modules_RevealOnScroll(document.querySelectorAll(".overview__item"), 75)
new modules_RevealOnScroll(document.querySelectorAll(".feature-item"), 80)
